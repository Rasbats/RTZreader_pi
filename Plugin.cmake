    ...
    if("${XERCES_HEADER}" MATCHES ".*-NOTFOUND")
      message(STATUS "xercesc not found")
       ...
       message(STATUS "xercesc found")
        target_include_directories(${PACKAGE_NAME} PUBLIC ${XERCES_HEADER}/include)
        find_library(XERCES_LIB lib xerces)
        if("${XERCES_LIB}" MATCHES ".*-NOTFOUND")
          message(STATUS "xercesc not found")
        else()
          target_link_libraries(${PACKAGE_NAME} ${XERCES_LIB})
        endif()
    endif()
  endif()
