...
set(PLUGIN_API_NAME RTZreader) # As of GetCommonName() in plugin API
...
set(PKG_HOMEPAGE https://github.com/Rasbats/RTZreader_pi)
set(PKG_INFO_URL https://opencpn.org/OpenCPN/plugins/RTZreader.html)

set(SRC
        src/RTZreader_pi.h
        src/RTZreader_pi.cpp
        src/icons.h
        src/icons.cpp
        src/RTZreadergui.h
        src/RTZreadergui.cpp
        src/RTZreadergui_impl.cpp
        src/RTZreadergui_impl.h
...
macro(add_plugin_libraries)
  ...
  if (UNIX AND NOT APPLE)
    add_subdirectory("${CMAKE_SOURCE_DIR}/libs/xercesc")
    ...
    if("${XERCES_HEADER}" MATCHES ".*-NOTFOUND")
      message(STATUS "xercesc not found")
       ...
       message(STATUS "Package folder name: ${CMAKE_SOURCE_DIR}/libs/xercesc/xerces-c/src")
       target_include_directories(${CMAKE_SOURCE_DIR}/libs/xercesc/xerces-c/src PUBLIC ${XERCES_HEADER})
       target_link_libraries(${CMAKE_SOURCE_DIR}/libs/xercesc/xerces-c/lib ocpn::xercesc)
    endif()
  endif()
